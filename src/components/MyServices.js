            ...
            <div className="container mx-auto text-center px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service, index) => (
                        <div key={index} className="bg-gray-100 dark:bg-gray-700 border  border-purple-300 dark:border-indigo-500  p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 my-4">
