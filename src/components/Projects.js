...
const Projects = () => {
    return (
        <section className="py-20" id="project">
            <h2 className="text-center text-3xl md:text-5xl font-bold mb-10">Projects</h2>
                ...
                {projects.map((project, index) => (
                    <div key={index} className="dark:bg-gray-800 bg-white p-5 rounded-lg flex flex-col justify-center items-center shadow-xl font-poppins">
                        ...
                        <div className="flex justify-between items-center gap-5">
                            <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className="text-xl">
                                <FaGithub />
                            </a>
                            <a href={project.liveLink} target="_blank" rel="noopener noreferrer" className="text-xl">
                                <FaExternalLinkAlt />
                            </a>
                        </div>
                    </div>
